                            ...
                            <div class="row">
                                ...
                                <div class='inner-div d-inline-block' style="float: right;">
                                    <form method='POST' action='"+full.destroy_url+"'>
                                        ...
                                        @if(getAdditionalPreference(['is_vendor_own_driver'])['is_vendor_own_driver']==0)
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @php
                                                $getAdditionalPreference = getAdditionalPreference(['update_order_product_price','is_enable_allergic_items','blockchain_route_formation','product_measurment']);
                                            @endphp
            ...
            <div class="card mb-0 h-100">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-3">{{ __('Cart Attachment') }}</h4>
                        ...
                        <input type="hidden" name="path_from_cart" id="path_from_cart" value="{{$order->attachment_path}}">
                        @php
                            if (isset($order->attachment_path) ) {
                                $attachment_path = "https://s3.us-west-2.amazonaws.com/royoorders2.0-assets".'/'.$order->attachment_path;
                            }
                        @endphp
                        <div class="col-4 product-box editPage mt-1" style="overflow: hidden;">
                            <div class="bg-light">
                                <img src="{{$attachment_path}}" style="width:100%;" class="vimg_{{$order->id}}" />
                            </div>
                        </div>         
                    @endif
                </div>
