        ...
        {{-- <div class="col-lg-4 col-xl-3 mb-3">
            ...
            <div class="col-lg-4 col-xl-3 mb-3">
                <form method="POST" action="{{route('configure.update', Auth::user()->code)}}" class="h-100">
                    ...
                    <div class="card-box mb-2 h-100">
                        <div class="d-flex align-items-center justify-content-between">
                        <h4 class="header-title mb-0">{{__('Payment Milestone')}}</h4>
                        <button class="btn btn-info d-block" type="submit"> {{ __("Save") }} </button>
                        </div>
                        <div class="row mt-2">
                        <div class="col-12">
                            <label class="primaryCurText">{{__('Total Milestones')}}</label>
                            <input class="form-control" type="number" id="total_payment_milestone" name="total_payment_milestone" value="{{ old('total_payment_milestone', $preference->total_payment_milestone  ?? '')}}" min="1">
                        </div>
                        </div>
                    </div>
                </form>
...
{{-- vendoe typs section aline by harbans singh :) --}}
    <div class="row col-spacing">
        ...
        <div class="col-xl-3 col-lg-3 mb-3">
            <div class="page-title-box">
                <h4 class="page-title text-uppercase">{{ __("Service Type") }}</h4>
            </div>
            ...
            <form method="POST" class="h-100" action="{{route('configure.update', Auth::user()->code)}}">
                ...
                <div class="card-box mb-2 h-100">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h4 class="header-title mb-0">{{ __("Service Type") }}</h4>
                        {{-- <button class="btn btn-info d-block" type="submit"> {{ __("Save") }} </button> --}}
                    </div>
    ...
    <div class="row col-spacing">
       <!-- User Authentication start-->
        ...
        <div class="col-md-4 mb-3">
            <div class="card-box pb-2 h-100">
                <div class="d-flex align-items-center justify-content-between">
                   <h4 class="header-title m-0">{{ __("Add Listing Document") }}</h4>
...
<div id="add_vendor_registration_document_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  standard-modalLabel aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header border-bottom al">
               <h4 class="modal-title" id="standard-modalLabel1">{{ __("Add Listing Form Document") }}</h4>
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
...
<div id="add_static_dropoff_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  standard-modalLabel aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header border-bottom al">
               <h4 class="modal-title" id="standard-modalLabel">{{ __("Add Listing Form Document") }}</h4>
               <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
