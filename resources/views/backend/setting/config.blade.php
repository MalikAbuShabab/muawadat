            ...
            <div class="col-xl-3 col-lg-6 mb-xl-0 mb-3">
                <div class="card-box h-100">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mb-0 switchery-demo">
                                <label for="nafath_login" class="d-flex align-items-center justify-content-between">
                                    <h5 class="social_head">
                                        <svg width="33" height="37" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="50" cy="50" r="45" fill="#fff" />
                                            <text x="50" y="55" font-size="70" fill="#43bee1" font-family="Arial, sans-serif" text-anchor="middle" direction="rtl">
                                            نفاذ
                                            </text>
                                        </svg>
                                        {{-- <span>{{ __('Nafath') }}</span> --}}
                                ...
                                <label for="" class="mr-3">{{ __('Enable') }}</label>
                                <input type="checkbox" data-plugin="switchery" name="nafath_login" id="nafath_login"
                                    class="form-control" data-color="#43bee1"
                                    @if (isset($preference) && $preference->nafath_login == '1') checked='checked' @endif>
                            </div>
                        </div>
                    </div>
                    <div class="row nafath_row"
                        style="{{ isset($preference) && $preference->nafath_login == '1' ? '' : 'display:none;' }}">
                        <div class="col-md-12">
                            <div class="form-group mb-2 mt-2">
                                <label for="nafath_client_id">{{ __('Nafath') }} {{ __('Client Key') }}</label>
                                <input type="text" name="nafath_client_id" id="nafath_client_id" placeholder=""
                                    class="form-control"
                                    value="{{ old('nafath_client_id', $preference->nafath_client_id ?? '') }}">
                                @if ($errors->has('nafath_client_id'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('nafath_client_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-2">
                                <label for="nafath_client_secret">{{ __('Nafath') }}
                                    {{ __('Client Secret') }}</label>
                                <input type="password" name="nafath_client_secret" id="nafath_client_secret"
                                    placeholder="" class="form-control"
                                    value="{{ old('nafath_client_secret', $preference->nafath_client_secret ?? '') }}">
                                @if ($errors->has('nafath_client_secret'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('nafath_client_secret') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-0">
                                <label for="nafath_client_url">{{ __('Nafath') }} {{ __('Redirect URL') }}</label>
                                <input type="text" name="nafath_client_url" id="nafath_client_url" placeholder=""
                                    class="form-control"
                                    value="{{ old('nafath_client_url', $preference->nafath_client_url ?? '') }}">
                                @if ($errors->has('nafath_client_url'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('nafath_client_url') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                    </div>
                </div><!-- Nafath card Over -->
            </div>
            <!-- Nafath card over -->
        </div>
    </form>
...
@section('script')
    ...
    //*************configurations hyperlocal map location selected by map*********************//
        ...
        // Nafat Login
        var nafat_login = $('#nafat_login');
        if (nafat_login.length > 0) {
            console.log(nafat_login);
            nafat_login[0].onchange = function() {
                alert('sd');
                if ($('#nafat_login:checked').length != 1) {
                    $('.nafat_row').hide();
                } else {
                    $('.nafat_row').show();
                }
