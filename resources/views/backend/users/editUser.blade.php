...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        ...
        <div class="col-5">
            ...
            <div class="page-title-box">
                @if(isset($subadmin))
                    <h4 class="page-title">{{ __('Identity Verification') }}</h4>
                @endif
                @if(session('identity_verified'))
                    @include('alert')
                @endif
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <div class="col-md-5">
                <form id="verified_doc_form" method="post" action="{{ route('customer.identity.verifed.update', $subadmin->id) }}" enctype="multipart/form-data">
                    @csrf
                <div class="card">
                    <div class="card-body">
                        <div class=" row">
                            <div class="col-md-12">
                                <div class="row justify-content-center">
                                    @php
                                        $frontImage = $userVerifydocs->firstWhere('file_type', 1);
                                        $backImage = $userVerifydocs->firstWhere('file_type', 2);
                                    @endphp
                                    {{-- Front Image --}}
                                    <div class="col-md-4 text-center">
                                        <h5 class="text-center">Front Image</h5>
                                        @if($frontImage)
                                            <div style="width: 190px; height: 120px; overflow: hidden; margin: 0 auto;">
                                                <img src="{{ $frontImage->image_file['storage_url'] }}" alt="Front Image"
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        @if($backImage)
                                            <div style="width: 190px; height: 120px; overflow: hidden; margin: 0 auto;">
                                                <img src="{{ $backImage->image_file['storage_url'] }}" alt="Back Image"
                                                    style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                                            </div>
                                        @else
                    ...
                    <div class="row text-center justify-content-center">
                        <div class="col-md-5">
                            <div class="form-group">
                                {!! Form::label('front_verified', __('Front Document Verified'), ['class' => 'control-label']) !!}
                                <div class="d-flex justify-content-center mt-2">
                                    <input type="checkbox" data-plugin="switchery" name="is_front_verified" class="is_front_verified verify-toggle"
                                        @if($subadmin->front_identity_doc_verified == 1) checked @endif>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                {!! Form::label('back_verified', __('Back Document Verified'), ['class' => 'control-label']) !!}
                                <div class="d-flex justify-content-center mt-2">
                                    <input type="checkbox" data-plugin="switchery" name="is_back_verified" class="is_back_verified verify-toggle"
                                        @if($subadmin->back_identity_doc_verified == 1) checked @endif>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mb-2 mt-4">
                    <div class="col-12">
                        <div class="form-group mb-0 text-center">
                            <button class="btn btn-blue btn-block" id="verifySubmit" type="submit" disabled > {{ __("Submit") }} </button>
                        </div>
                    </div>
                </div>
            </form>
...
@section('script')
    ...
    function toggleSubmitButton() {
        const anyChecked = document.querySelectorAll('.verify-toggle:checked').length > 0;
        document.getElementById('verifySubmit').disabled = !anyChecked;
    }
    ...
    document.querySelectorAll('.verify-toggle').forEach(toggle => {
        toggle.addEventListener('change', toggleSubmitButton);
    });
</script>
