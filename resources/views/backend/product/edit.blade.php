        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                @endif
                    ...
                    <!-- P2P BID FINANCIAL INFO START -->
                    @if($product->category->categoryDetail->type_id != 7)
                        <div class="card-box">
                            <h5 class="text-uppercase mt-0 mb-3 bg-light p-2 def">{{ __("Financial Info ") }}</h5>
                            @if($product->has_variant == 0)
                                <div class="row mb-2">
                                    @if(@$product->vendor->is_seller == 0 || Auth::user()->is_superadmin == 1 )
                                        <div class="row">
                                            <input type="hidden" name="financial_info_id" class="financial_info_id" value ="{{ $product->financialInfo->id ?? ''}}">
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Growth Opportunity</label>
                                                <input type="text" class="form-control" name="growth_opportunity" id="growth_opportunity" placeholder="Growth opportunity" value="{{ $product->financialInfo->growth_opportunity ?? ''}}">
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Financial Data</label>
                                                <input type="text" class="form-control" name="finanical_data" id="finanical_data" placeholder="Financial data" value="{{ $product->financialInfo->financial_data ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Matrics</label>
                                                <input type="text" class="form-control" name="matrix" id="matrix" placeholder="Matrix" value="{{ $product->financialInfo->matrics ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Data Room</label>
                                                <input type="text" class="form-control" name="data_room" id="data_room" placeholder="Room data" value="{{ $product->financialInfo->data_room ?? ''}}" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Marketing</label>
                                                <input type="text" class="form-control" name="marketing" id="marketing" placeholder="Marketing" value="{{ $product->financialInfo->marketing ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Price</label>
                                                <input type="text" class="form-control" name="price" id="price" placeholder="Price" value="{{ $product->financialInfo->price ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Proposed Price</label>
                                                <input type="text" class="form-control" name="propsal_price" id="propsal_price" placeholder="Proposed price" value="{{ $product->financialInfo->proposed_price ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Offer Type</label>
                                                <input type="text" class="form-control" name="offer_type" id="offer_type" placeholder="Offer type" value="{{ $product->financialInfo->offer_type ?? ''}}" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Offer Note</label>
                                                <input type="text" class="form-control" name="offer_note" id="offer_note" placeholder="Offer notes"value="{{ $product->financialInfo->notes_offer ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Share Percentage</label>
                                                <input type="text" class="form-control" name="share_percentange" id="share_percentange" placeholder="Share percentage" value="{{ $product->financialInfo->share_precentage ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Email Address</label>
                                                <input type="text" class="form-control" name="email_address" id="email_address" placeholder="Email address" value="{{ $product->financialInfo->email_address ?? ''}}" >
                                            </div>
                                            <div class="col-3 mb-2">
                                                <label for="title" class="control-label">Sale Reason</label>
                                                <textarea name="reason_for_sale" id="reason_for_sale" cols="24" rows="3">{{ $product->financialInfo->marketing ?? ''}}</textarea>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                    ...
                    @if($product->category->categoryDetail->type_id != 7)
                        @if(!empty($product->dynamicFormData) && $product->dynamicFormData->count() > 0)
                            <div class="card-box">
                                <h5 class="text-uppercase mt-0 mb-3 bg-light p-2 def">{{ __("Dyanimic Fields") }}</h5>
                                @if($product->has_variant == 0)
                                    <div class="row mb-2">
                                        @if(@$product->vendor->is_seller == 0 || Auth::user()->is_superadmin == 1 )
                                            <div class="row">
                                                @foreach ($product->dynamicFormData as $field)
                                                    <div class="col-3 mb-2">
                                                        <label for="{{ $field->field_name }}" class="control-label">
                                                            {{ ucfirst(str_replace('_', ' ', $field->field_name)) }}
                                                        </label>
                                                        <input type="text" class="form-control" name="dynamic_fields[{{ $field->field_name }}]" id="{{ $field->field_name }}" placeholder="{{ $field->field_name }}"  value="{{ $field->field_value }}">
                                                    </div>
                                                @endforeach
                                            </div>
                                        @endif
            ...
            <div class="col-lg-5">
                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        ...
                        {{-- @if( !in_array($product->category->categoryDetail->type_id,[8,7,12])) <!-- P2P BID -->
                    ...
                    {{--@if($configData->minimum_order_batch == 1 || $product->minimum_order_count > 0)--}} <!-- P2P BID -->
                    {{-- <div class="row">
                        @if($getAdditionalPreference['is_price_by_role'] == '1')
                            <div class="col-md-6 mb-2">
                    ...
                    {{-- product free delivery fees --}} <!-- P2P BID -->
                            ...
                            @foreach ($product->media as $media)
                                @php
                                    ...
                                    if (isset($media->image) && is_array($media->image->path)) {
                                        ...
                                        $imageContent = @file_get_contents($mediaPath); // use @ to suppress errors
                                        ...
                                        continue; // Skip if image data is not valid
                                    }
                                @endphp

                                <div class="col-4 product-box editPage mt-1">
                                    <div class="product-action">
                                        <a href="{{ route('product.deleteImg', [$product->id, $media->id]) }}"
                                    ...
                                    <div class="bg-light">
                                        <img src="{{ $mediaPath }}" style="width: 100%;" />
                                    </div>
                                </div>
                            @endforeach
                        @endif
                ...
                @if($client_preference_detail->business_type != 'taxi') <!-- P2P BID -->
                    {{-- <div class="card-box" style="display:{{(($product->global_product_id!='')?'none':'block')}}">
                ...
                {{-- mohit sir branch code added by sohail --}}  <!--P2P BID -->
...
<script type="text/javascript">
    ...
    $('#add_vendor_registration_document_modal_btn').click(function(e) {
        ...
        $('#add_vendor_registration_document_modal #standard-modalLabel').html('Add Listing Form Document');
    });
