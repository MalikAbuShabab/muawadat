        ...
        <div class="col-md-12">
            <form name="config-form" action="{{route('vendor.config.update', $vendor->id)}}" class="needs-validation" id="slot-configs" method="post">
                ...
                <div class="row mb-2">
                    ...
                    @if (getAdditionalPreference(['is_vendor_own_driver'])['is_vendor_own_driver'] == 1)
                    <div class="col-md-12 mb-2 d-flex align-items-center justify-content-between">
                        {!! Form::label('title', __('Is Vendor Own Driver'),['class' => 'control-label']) !!}
                        <input type="checkbox" data-plugin="switchery" name="is_vendor_own_driver" class="form-control" data-color="#43bee1" @if($vendor->is_vendor_own_driver == 1) checked @endif {{$vendor->status == 1 ? '' : 'disabled'}}>
                    </div>
                    @endif
...
@if (Auth::user()->is_superadmin == 1) 
    <div class="card-box">
        {{-- <div class="row text-left"> <!--P2P BID-->
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
...
@if(auth()->user()->can('vendor-add-users') || auth()->user()->is_superadmin)  <!--P2P BID-->
 {{-- <div class="card-box">
