                ...
                <div class="col-sm">
                    ...
                    <div class="card alDasBoxItems">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="" title="Number of Orders">{{__('Customer Request')}}</h5>
                            <h3 class="mt-3 mb-3" id="total_drafted_products">0</h3>
                            {{-- <p class="mb-0" id="orders_change">
                            </p> --}} 
                        </div>
                        </a>
                ...
                <div class="col-sm">
                    ...
                    <div class="card alDasBoxItems">
                        <div class="card-body">
                            ...
                            @endphp
                            <h5 class="" title="Number of Vendors">{{__('Sellers')}}</h5>
                ...
                <div class="col-sm">
                    <div class="card alDasBoxItems">
                        <div class="card-body">
                            ...
                            <h5 class="" title="Number of Revenue">{{ __('Total Company Placed') }}</h5>
                ...
                <div class="col-sm">
                    ...
                    <div class="card alDasBoxItems">
                        <div class="card-body">
                            ...
                            <h5 class="" title="Number of Revenue">{{ __('Total Placed Company') }}</h5>
                ...
                <div class="col-sm">
                    ...
                    <div class="card alDasBoxItems">
                        <div class="card-body">
                            ...
                            @endphp
                            <h5 class="" title="Number of Growth">{{ __('Companies') }}</h5>
                ...
                <div class="col-sm">
                    <div class="card alDasBoxItems">
                        <div class="card-body">
                            ...
                            <h5 class="" title="Number of Managers">{{ __('Subscribers') }}</h5>
                            <h3 class="mt-3 mb-3" id="subscribed_users">+ 0</h3>
                            {{-- <p class="mb-0" id="managers_change">
                            </p> --}}
                        </div>
                    </div>
