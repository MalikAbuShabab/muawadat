...
<div class="container-fluid vendor-page">
        ...
        <div class="col-sm-6">
            <div class="page-title-box">
                @php
                    ...
                    $newvendors = ($vendors === "vendors") ? __('Subscribed Users') : $vendors ;
                    ...
                    <div class="row">
                        <div class="col-6 col-md-3 mb-3 mb-md-0">
                            {{-- <div class="text-center">
                                <h3>
                                    ...
                                    <span data-plugin="counterup" id="total_earnings_by_vendors"></span>
                                   
                                </h3>
                                <p class="text-muted font-15 mb-0">{{ __('Draft Companies') }} </p>
                        ...
                        {{-- <div class="col-6 col-md-3 mb-3 mb-md-0">
                            <div class="text-center">
                                ...
                                <p class="text-muted font-15 mb-0">{{ __('Publish Companies') }} </p>
                            </div>
                        </div> --}}
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <table id="newsletterSubscribersTable" class="table table-bordered">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Email</th>
  ...
  toastr.options = {
    ...
    $(document).ready(function() {
        ...
        $('#newsletterSubscribersTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('p2p.admin.newsletter.subscribers') }}",
            columns: [
                { data: 'id', name: 'id' },
    ...
    //         processing: true,
    //         serverSide: true,
    //         // ajax: "{{ route('p2p.admin.draft-product.list') }}", // Your Laravel route to fetch data
    //         ajax: {
