                                        ...
                                        <div class="card-box child-card">
                                            <div class="row  align-items-center">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <div class="medal-img">
                                                        <img src="{{@$signatureImg['image_fit'].'400/400/sm/0/plain/'.$signatureImg['original_seller_image']}}" alt="">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12 text-center">
                                            <div class="card-box earn-points p-2">
                                                <div class="points-title1" style="color:red;">
                                                    <div class="text-center" ><strong>{{__('Buyer Contract Signed Not Found !')}} </strong></div>
                                                </div>
