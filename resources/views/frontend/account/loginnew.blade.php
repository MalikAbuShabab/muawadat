    ...
    <section class="wrapper-main d-flex align-items-center">
        <div class="container">
            <div class="row align-items-center rounded bg-white" id="login-section">
                ...
                @endif
                <div
                    class="col-lg-6 muawadat_login_2 mb-lg-0 mb-3 pb-sm-0 {{(@$getAdditionalPreference['is_phone_signup'] == 1) ? 'offset-lg-3' : '' }}">
                    <div class="max-form">
                        <div class="text-left">
                            <a href="/">
                        ...
                        <div class="row mt-3 arabic-language">
                            <div class="col-md-12 text-left">
                                {{-- <form name="login" id="login" action="{{route('customer.loginData')}}" class="px-lg-4"
                                    method="post">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="email"
                                            ...
                                            aria-describedby="" placeholder="{{ __('Email') }}" value="{{ old('email')}}"
                                            name="email">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            ...
                                            <button type="submit" class="btn btn-solid submitLogin">{{ __('Login')
                                                }}</button>
                                        </div>
                                        <div class="col-md-6 text-md-right">
                                            <a class="forgot_btn" href="{{url('user/forgotPassword')}}">{{ __('Forgot
                                                Password?') }}</a>
                                        </div>
                                    </div>
                                </form> --}}
                                    ...
                                    <div class="login-with-username">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="username"
                                                placeholder="{{ ($getAdditionalPreference['is_phone_signup'] == 1) ? __('Phone Number') : __('Enter Email address') }}"
                                                required="" name="username" value="{{ old('username')}}">
                                        </div>
                                        <div class="form-group" id="password-wrapper"
                                            style="display:block; position:relative">
                                            <label>Password</label>
                                            <input id="password-field" type="password" class="form-control pr-3"
                                        ...
                                        <div>
                                            <a class="font-14 forgot" href="{{ url('user/forgotPassword')}}"
                                                id="olddd_send_password_reset_link"
                                                style="float:right;color:#015158 !important; font-weight:600 display:inline-block; margin-bottom:16px;">{{ __('Forgot Password?') }}</a>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <button class="text-white darkgreen btn btn-primary rounded w-100"
                                        ...
                                        @if(session('preferences'))
                                            @if(@session('preferences')->fb_login == 1 || @session('preferences')->twitter_login == 1 || @session('preferences')->google_login == 1 || @session('preferences')->apple_login == 1)
                                                ...
                                                <ul class="social-links d-flex align-items-center mx-auto">
                                                    ...
                                                    @if(@session('preferences')->fb_login == 1)
                                                        <li>
                                                            <a href="{{url('auth/facebook')}}"><img
                                                                    src="{{asset('front-assets/images/facebook.svg')}}" alt=""></a>
                                                        </li>
                                                    @endif
                                                    @if(@session('preferences')->twitter_login)
                                                        <li>
                                                            <a href="{{url('auth/twitter')}}"><img
                                                                    src="{{asset('front-assets/images/twitter.svg')}}" alt=""></a>
                                                        </li>
                                                    @endif

                                                    @if(@session('preferences')->nafath_login)
                                                        <li>
                                                            <a href="#">
                                                                <svg width="33" height="37" viewBox="0 0 100 100"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <circle cx="50" cy="50" r="45" fill="#2A9999" />
                                                                    <text x="50" y="55" font-size="40" fill="white"
                                        ...
                                        <div class="form-group text-center have_acc">
                                            ...
                                            <h5>Don't Have An Account? <span style="color:#015158;"><a
                                                        href="{{route('customer.register')}}">{{ __('Sign Up') }}</a></span>
                                            </h5>
                                        </div>
                                    </div>
                                </form>
...
@section('script')
    ...
    <script>
        ...
        $('#send_password_reset_link_old').click(function () {
            var that = $(this);
            var email = $('#username').val();
            $('.invalid-feedback').html('');
            $.ajax({
