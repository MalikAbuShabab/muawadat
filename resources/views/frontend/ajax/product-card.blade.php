...
<div class="product-wrapper-grid">
    <div class="row margin-res vendor_first">
        ...
        <div class="col-xl-3 col-md-3 col-6 mt-3">
            <a href="{{route('productDetail', [$data->vendor->slug,$data->url_slug])}}" target="_blank" class="product-box scale-effect1 mt-0 product-card-box position-relative al_box_third_template al">
                <div class="product-image">
                    <img class="img-fluid blur-up lazyload" data-src="{{$data->image_url}}" alt="">
                </div>
                <div class="media-body align-self-center" style="background: #015158;" >
                    <div class="inner_spacing w-100">
                        ...
                        <div class="product-description_list border-bottom1">
                            ...
                            {{-- <div class="product-price-chat-sec">
                                @if($data->inquiry_only == 0)
                                    ...
                                    <h4 class="mt-1">AED {{(decimal_format($data->variant_price * $data->variant_multiplier))}}</h4>
                                @endif
                            </div> --}}
                                ...
                                <div class="inner_spacing px-0">
                                    <div class="product-description">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6 class="card_title ellips1 text-white">{{$data->translation_title}}</h6> 
                                        </div>
                                        
                                        <p class="border-bottom pb-1 d-none">
                                            <span>In OwnerShip </span>
                                        </p>
                                         
                                        <div class="d-flex align-items-center justify-content-between al_clock"> 
                                            
                                            <b class="text-white" style="margin-right: 20px;" >{{$currencysymbol}} {{ decimal_format($data->variant_price) ?? ''}} </b><br>
                                            
                                            <p class="text-white"><i class="fa fa-map-marker"></i> 
                                                {{$data->address ?? 'N/A'}} </p>   
