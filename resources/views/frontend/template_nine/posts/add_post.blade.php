                ...
                <div class="item">
                    <div class="alPostHead text-center bg-light position-relative py-3">
                        ...
                        <div class="form-step active" id="form-1">
                            <form autocomplete="off" name="form1" id="form1" >
                                ...
                                <div class="input-group">
                                    <label for="birth-date">{{__('About')}}</label>
                                    <input type="text" name="company_description" id="company_description" placeholder="{{__('About')}}" class="validate-input" >
                                    <span class="validate_error" style="color: red;"></span>
                                </div>
                                <div class="input-group">
                                ...
                                <div class="input-group">
                                    <label for="inputAddress" class="w-100">{{__('Location Availability')}} *</label>
                                ...
                                <div class="input-group">
                                    <label for="birth-date">{{__('Upload Images')}}</label>
