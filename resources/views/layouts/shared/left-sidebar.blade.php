...
<div class="left-side-menu">
    <div class="logo-box d-lg-block" style="height: auto">
        @php
            ...
            $VendorsTrans = ($Vendors=="Vendors")?__('Vendorsseller'):$Vendors;
    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a class="menu-title pl-1" href="#">
                        @php
                            ...
                            $ordermenulabel = ($ordermenu=="Orders")?__('Main'):__($ordermenu);
                    ...
                    <ul class="nav-second-level p-0 mx-2">
                            ...
                            @if(@auth()->user()->can('accounting-view') || Auth::user()->is_superadmin == 1) <!--P2P BID-->
                                {{-- <li>
                            ...
                            {{-- @if(count(array_intersect($subscription_permissions, $allowed)) || Auth::user()->is_superadmin == 1) --}}
                                {{-- @if($client_preference->subscription_mode == 1) --}}
                                    ...
                                    @if(@auth()->user()->can('vendor-view') || Auth::user()->is_superadmin == 1)
                                    <li>
                                        <a href="{{route('p2p.admin.bid.list')}}">
                                        <span class="icon-vendor"></span>
                                        @php
                                            $vendormenu = getNomenclatureName('Vendors', true);
                                            $vendormenulabel = ($vendormenu=="Vendors")?__('Vendors'):__($vendormenu);
                                        ...
                                        @endphp
                                            <span>{{__('Bid List')}}</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a href="{{route('p2p.admin.draft-product.list.show')}}">
                                ...
                                <div class="collapse" id="sidebarreports">
                                    <ul class="nav-second-level">
                                        ...
                                        <li>
                                            ...
                                            <a href="{{route('review.index')}}">{{ __('Company Review') }}</a>
                                        </li>
                                        @endif
                            ...
                            @if(Auth::user()->is_superadmin == 1) <!-- P2P BID -->
                            {{-- <li>
                ...
                <li>
                   <a class="menu-title pl-1" href="#">
                    ...
                    <ul class="nav-second-level p-0 mx-2">
                        ...
                        @if(@auth()->user()->can('tax-view') || Auth::user()->is_superadmin == 1) <!--P2P BID-->
                            {{-- <li>
                        ...
                        @endif
                        @if(@auth()->user()->can('payment-option-view') || Auth::user()->is_superadmin == 1) <!--P2P BID-->
                            {{-- <li>
                ...
                @endif
                @if(Auth::user()->is_superadmin == 1 || Auth::user()->is_admin == 1) <!--P2P BID-->
                <li>
                    <a class="menu-title pl-1" href="#">
                    ...
                    <ul class="nav-second-level p-0 mx-2">
                        @if(Auth::user()->is_superadmin == 1)
                        <li>
                            <a href="{{route('p2p.admin.newsletter.subscribers')}}">
                            <span class="icon-catalogue"></span>
                                <span>{{__('Subscribed Users')}}</span>
                            </a>
                        </li>
                        @endif
                        {{-- @if(Auth::user()->is_superadmin == 1)
                ...
                @if(count(array_intersect($extra_permissions, $allowed)) || (Auth::user()->is_admin == 1 || Auth::user()->is_superadmin == 1 ) || in_array('tools',$allowed))
                    <li>
                        ...
                        <li>
                            <a href="{{route('p2p.support.list')}}">{{ __('Support') }}</a>
                        </li>
                        @endif
                        {{-- <ul class="nav-second-level p-0 mx-2">
