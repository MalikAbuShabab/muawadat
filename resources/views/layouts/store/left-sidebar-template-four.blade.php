...
@if((\Request::route()->getName() != 'customer.login') && (\Request::route()->getName() != 'customer.register') && (\Request::route()->getName() != 'user.verify'))
    <header id="al_four_design"
        class="site-header @if ($client_preference_detail->business_type == 'taxi') taxi-header @endif">
                        ...
                        <div class="row d-flex align-items-center justify-content-between">
                            <div class="col-lg-2">
                                <div class="logo_area d-none d-lg-block">
                                    <a class="navbar-brand alFourThLogo m-0" href="{{ route('userHome') }}"><img alt=""
                                            class="logo-image" style="height:50px;" src="{{$urlImg}}"></a>
                                </div>
                                <div class="col-12 d-block d-lg-none p-0">
                                    <div class="row no-gutters">
                                                    ...
                                                    <ul class="header-dropdown ml-auto">
                                                        ...
                                                        <li class="onhover-dropdown change-language">
                                                            <a href="javascript:void(0)">{{$applocale}}
                                                                <span class="icon-ic_lang align-middle"></span>
                                                                <span
                                                                    class="language ml-1 align-middle">{{ __("language") }}</span>
                                                            </a>
                                                            <ul class="onhover-show-div">
                                                                @foreach($languageList as $key => $listl)
                                                                    <li
                                                                        class="{{$applocale == $listl->language->sort_code ? 'active' : ''}}">
                                                                        <a href="javascript:void(0)" class="customerLang"
                                                                            langId="{{$listl->language_id}}">{{$listl->language->name}}@if($listl->language->id != 1)
                                                        ...
                                                        <li class="onhover-dropdown change-currency">
                                                            <a href="javascript:void(0)">{{session()->get('iso_code')}}
                                                                <span class="icon-ic_currency align-middle"></span>
                                                                <span
                                                                    class="currency ml-1 align-middle">{{ __("currency") }}</span>
                                                            </a>
                                                            <ul class="onhover-show-div">
                                                                @foreach($currencyList as $key => $listc)
                                                                    <li
                                        ...
                                        <div class="col-8">
                                            <a class="navbar-brand m-0" href="{{ route('userHome') }}"><img alt=""
                                                    class="logo-image w-100" style="height:60px;" src="{{$urlImg}}"></a>
                                        </div>
                                            ...
                                            <div class="onhover-div pl-0 ml-xl-3 ml-lg-1 shake-effect d-block d-md-none">
                                                <div class="d-flex">
                                                    @if(Session::get('vendorType') == 'p2p')
                                                        <li class="add_post pr-2"><a
                                                                href="{{route('posts.index', ['fullPage' => 1])}}"
                                                                class="sell-btn">
                                                                <span>
                                                    ...
                                                    @if($client_preference_detail)
                                                        @if($client_preference_detail->cart_enable == 1)
                                                            <a class="addToCardBtn d-flex align-items-center "
                                                                href="{{route('showCart')}}">
                            ...
                            <div class="col-lg-10">
                                <div class="row">
                                    <div
                                        ...
                                        @endif
                                        <div
                                            class="d-inline-flex al_searchType border align-items-center justify-content-start px-xl-2 px-lg-1 position-relative">
                                            <button class="btn px-lg-0"><i class="fa fa-search"
                                                    aria-hidden="true"></i></button>
                                            @php $searchPlaceholder = getNomenclatureName('Search', true);
                                            $searchPlaceholder = ($searchPlaceholder === 'Search product, vendor, item') ? __('Search product, vendor, item') : $searchPlaceholder; @endphp
                                        ...
                                        <ul class="header-dropdown ml-auto d-lg-block d-none">
                                            @if(p2p_module_status() && Session::get('vendorType') == 'p2p')
                                                <li><a href="{{route('posts.index', ['fullPage' => 1])}}"
                                                        class="sell-btn"><span><i class="fa fa-plus"
                                    ...
                                    @endforeach -->
                                            ...
                                            @if(count($languageList) > 1)
                                                <li class="onhover-dropdown mobile-account pr-2">
                                                    <span class="al_BGcolor"><i class="fa fa-globe"
                                                            aria-hidden="true"></i></span>
                                                    {{__('Language')}}

                                                    <ul class="onhover-show-div"> @foreach ($languageList as $key => $list)
                                                        <li
                                                            class="{{ session()->get('locale') == $list->language->sort_code ? 'active' : '' }}">
                                                            <a href="javascript:void(0)" class="customerLang"
                                                                langId="{{ $list->language_id }}">{{ $list->language->name }}</a>
                                                    </li> @endforeach
                                                    </ul>
                                            ...
                                            <li class="onhover-dropdown mobile-account pr-2">
                                                <span class="al_BGcolor"><i class="fa fa-user"
                                                        aria-hidden="true"></i></span>
                                                {{__('My Account')}}
                                                <ul class="onhover-show-div">
                                                    @if(Auth::user())
                                    ...
                                    @if(@$navCategories && count($navCategories))
                                        <div class="col-sm-12 p-0 d-flex align-items-center alOverflow">
                                            <div class="menu_navigation_al_four mt-lg-3">
                                                <ul id="main-menu"
                                                    class="sm pixelstrap sm-horizontal menu-slider d-flex justify-content-center">
...
<div
    class=" @if((\Request::route()->getName() != 'userHome') || ($client_preference_detail->show_icons == 0)) inner-pages-offset al_offset-top @else al_offset-top-home @endif @if($client_preference_detail->hide_nav_bar == 1) set-hide-nav-bar @endif">
</div>
...
<% _.each(nav_categories, function(category, key){ %>
    <% var icon_two_url=null; if(category.icon_two !=null){ icon_two_url=category.icon_two.image_fit + '200/200' +
        category.icon_two.image_path; }else{ icon_two_url=category.icon.image_fit + '200/200' +
