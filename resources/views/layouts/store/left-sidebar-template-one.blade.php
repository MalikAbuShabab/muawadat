...
<style>
    ...
    /* Bell Icon */
    .notification-icon {
        background: #004d56; /* Dark background */
        width: 34px;
        height: 34px;
        display: flex;
        align-items: center;
...
@endphp
<link rel="stylesheet" href="{{ asset('frontend/common/front_theme_style.css')}}">
<article class="@if(Request::is('/')) scroll-bgcolor-for-home @endif site-header @if ($client_preference_detail->business_type == 'taxi') taxi-header @endif">
...
{{-- P2p Template --}}
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="{{route('userHome')}}"><img alt="" src="{{asset('images/p2plogo.png')}}"></a></a>
        ...
        <div class="collapse navbar-collapse justify-content-end " id="navbarSupportedContent">
          ...
          <ul class="navbar-nav text-white">
            <li class="nav-item active">
              <a class="nav-link"  id="link1" href="{{route('userHome')}}">{{__('Home')}} </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="link2" href="{{route('userChat.UserToUserChat')}}">{{__('Message')}}</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" id="link3" href="{{route('p2p.bid.list')}}">{{__('My Bids')}}</a>
            </li>

            <li class="nav-item">
                <a class="nav-link marked_bid_as_viewed" id="link4" href="{{route('p2p.marketpalce.list')}}">{{__('Marketplace')}} <span class="badge badge-danger d-none" id="bidCount">0</span></a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center position-relative" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @if(Auth::check())
                        <div class="profile-container">
                            <!-- Profile Picture -->
                            <img src="{{asset('assets/images/dummy_user.png') }}" 
                                 alt="Profile Picture" 
                                 class="profile-pic">
                    ...
                    @endif
                    <span class="mx-1">{{__('My Account')}}</span>
                    <i class="fa fa-chevron-down ml-1 dropdown-arrow" style="font-size: 11px;"></i> <!-- Arrow Icon -->
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="top: 79%!important;left: 20px;">
                    @if(Auth::check())
                        @if(Auth::user()->is_superadmin == 1 || Auth::user()->is_admin == 1)
                            <a href="{{route('client.dashboard')}}" data-lng="en" class="dropdown-item">
                                <i class="fas fa-tachometer-alt topbar-my-account-icon" ></i> {{ getNomenclatureName('Control Panel', true) }}
                            </a>
                        @endif
            
                        <a href="{{route('user.profile')}}" data-lng="en" class="dropdown-item"><i class="fas fa-user  topbar-my-account-icon" ></i> {{ __('Profile') }}</a>
                        {{-- Display Admin or User Label Below Logout --}}
                        <a href="{{route('user.logout')}}" data-lng="es" class="dropdown-item"><i class="fas fa-sign-out-alt  topbar-my-account-icon" ></i> {{ __('Logout') }}</a>
                        @if(Auth::user()->is_superadmin == 1)
                            <span class="dropdown-item fw-bold text-success">
                                <i class="fas fa-user-shield topbar-my-account-icon"></i> {{__('Admin')}}
                            </span>
                        @else
                            <span class="dropdown-item fw-bold text-info">
                                <i class="fas fa-user topbar-my-account-icon"></i> {{__('User')}} 
                            </span>
                        @endif
                    ...
                    @else
                        ...
                        @if(isset($getAdditionalPreference) && ($getAdditionalPreference['is_user_pre_signup'] == 1))
                            <a href="{{route('customer.register')}}" data-lng="es" class="dropdown-item">{{ __('Pre Signup') }}</a>
                        @else
                            <a href="{{route('customer.login')}}" data-lng="en" class="dropdown-item">{{ __('Login') }}</a>
                            <a href="{{route('customer.register')}}" data-lng="es" class="dropdown-item">{{ __('Register') }}</a>
                        @endif
                    @endif
                </div>
            </li>
            ...
            @if(Auth::check() && Auth::user()->is_superadmin)
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle notification-container" href="#" id="notificationDropdown" role="button" data-toggle="dropdown">
                        <div class="notification-icon">
                            <i class="fa fa-bell"></i> <!-- Bell Icon -->
                        </div>
                        <span class="notification-badge badge-danger" id="notificationCount" style="display: none;">0</span> <!-- Notification Badge -->
                    </a>
                    <div class="dropdown-menu dropdown-menu-right notification_menu" aria-labelledby="notificationDropdown">
                        <ul id="notificationList" class="list-group pl-0" style="width:250px !important">
            ...
            @if(Auth::check() && Auth::user()->is_superadmin==0) 
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle notification-container" href="#" id="notificationDropdownUser" role="button" data-toggle="dropdown">
                        <div class="notification-icon">
                            <i class="fa fa-bell"></i> <!-- Bell Icon -->
                        </div>
                        <span class="notification-badge" id="notificationCountUser">0</span> <!-- Notification Badge -->
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notificationDropdownUser">
                        <ul id="notificationListUser" class="list-group pl-0" style="width:250px !important">
                            <li class="list-group-item py-2">No new notifications</li>
                        </ul>
                    </div>
                </li>
        ...
        <!-- Over  -->
            ...
            {{-- <li class="nav-item">
              <a class="nav-link add-listing-btn" href="{{route('posts.index', ['fullPage'=>1])}}" tabindex="-1" ><i class="fa fa-plus" aria-hidden="true"></i> {{ __('Add Listing') }}</span></a>
            </li> --}}
            <li class="nav-item">
                <a class="nav-link add-listing-btn"
                   href="#"
                   onclick="checkDocumentStatus(event)"
                   ...
                   tabindex="-1">
                    <i class="fa fa-plus" aria-hidden="true"></i> {{ __('Add Listing') }}
                </a>
            </li>
          </ul>
        </div>
      ...
      <div class="main-menu al_template_one_menu">
         {{-- <div class="container-fluid d-block ">
                ...
                <div class="col-lg-12"> --}}
                  {{--  @include('layouts.store.topbar-template-nine')--}}
                    {{-- <div class="row mobile-header align-items-center justify-content-between">
                        <div class="logo">
                            <a class="navbar-brand w-25 p-0  align-items-center" href="{{route('userHome')}}"><img alt="" src="{{asset('images/p2plogo.png')}}"></a> --}}
                            {{-- <div class="radius-bar d-xl-inline al_custom_search mr-sm-2">
                                <div class="search_form d-flex align-items-start justify-content-start"> 
                                    ...
                                    __('Search product, vendor, item') : $searchPlaceholder; @endphp <input
                                        ...
                                        autocomplete="off" style="display:none;"> </div>
                        ...
                        {{-- <div class="al_count_tabs w-75 my-1 d-flex justify-content-end">
                            
                            <ul class="navbar nav nav-tabs navigation-tab nav-material tab-icons vendor_mods"
                             id="navbar" role="tablist">
                                {{-- @foreach(config('constants.VendorTypes') as $vendor_typ_key => $vendor_typ_value) --}}
                                  
                                   
                                    {{-- <li class="navigation-tab-item"> <a  class="nav-link header-link" href="#" id="link1"> Home</a></li>
                                    <li class="navigation-tab-item"><a  class="nav-link header-link" href="{{route('userChat.UserToUserChat')}}" id="link2"> Messages</a></li>
                                    <li class="navigation-tab-item"><a href="{{route('p2p.bid.list')}}" class="nav-link header-link" id="link3"> My Bids</a></li>
                                    <li class="navigation-tab-item"><a  href="{{route('p2p.marketpalce.list')}}" class="nav-link header-link" id="link4"> Marketplace</a></li>
                                    <li class="onhover-dropdown mobile-account">  --}}
                                            
                                                                                                                                                                                                                                   
                                        {{-- <span class="d-flex align-items-center" style="gap: 10px;">  <svg width="16" height="16" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            ...
                                            <rect x="0.154297" y="0.271164" width="28.6809" height="29.3101" fill="white"/>
                                            </g>
                                            <defs>
                                  ...
                                  --}}
                                    ...
                                    <li class="add_post"><a href="{{route('posts.index', ['fullPage'=>1])}}" class="sell-btn"><span><i class="fa fa-plus" aria-hidden="true"></i>{{ __('Add Listing') }}</span></a></li>
                                    @endif --}}
                                    {{-- @endforeach --}}
            ...
            <!-- BELOW HIDE CATEGROY LIST WITH D-NONE CLASS --> 
            <div class="menu-navigation al d-none">
                       ...
                       data.forEach(notification => {
                        ...
                        //    let userImage = notification.data.user_image ? notification.data.user_image: dummy_image;
                           ...
                           if (notification.data.notification_type === "bid_status") {
                            ...
                            if (notification.data.notification_type === "newBidRequestNotifyToToSeller") {
                            
                                //  redirectUrl = notification.data.post_url; // Redirect to the post
                                var redirectUrl = "{{ route('p2p.marketpalce.list') }}";
                                let bidStatus = notification.data.bid_status.toLowerCase(); // Convert to lowercase for consistency
                                let notificationColor = bidStatus === 'rejected' ? 'red' : 'green';
                            ...
                            //    notificationMessage = `📝 Bid ${notification.data.bid_status}: <strong>${notification.data.product_name}</strong>`;
                                    var notificationMessage = `
                                    <div style="color: ${notificationColor}; font-weight: bold;">
                                        📝 New Bid Request for: <strong>${notification.data.product_name}</strong>
                                    </div>`;
                                    
                            }
                            if (notification.data.notification_type === "ownershipTransferToBuyer") {
                            
                            //  redirectUrl = notification.data.post_url; // Redirect to the post
                            var redirectUrl = "{{ route('buyer.list-milestone') }}";
                            let bidStatus = notification.data.bid_status.toLowerCase(); // Convert to lowercase for consistency
                            let notificationColor = bidStatus === 'rejected' ? 'red' : 'green';
                                var notificationMessage = `
                                <div style="color: ${notificationColor}; font-weight: bold;">
                                    📝 Ownership Transfer for: <strong>${notification.data.product_name}</strong>
                                </div>`;
...
<script>
    $(document).ready(function () {
        function fetchBidCount() {
            $.ajax({
                url: "{{ route('marketpalce.seller-bid-count') }}",
                method: "GET",
                success: function(response) {
                    console.log(response);
                    
                    if(response.bid_count > 0){
                        $('#bidCount').removeClass('d-none');
                        $('#bidCount').text(response.bid_count);
                    }
                }
            });
        }
        ...
        function markBidsAsViewed() { // Bid marked as viewed  by seller
                url: "/marketplace/mark-bid-as-viewed", // Bid marked as viewed route
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                },
        ...
        $(".marked_bid_as_viewed").on("click", function () {
            markBidsAsViewed();
        });
...
<script>
    ...
    // On page load, check if there's an active link stored in localStorage
