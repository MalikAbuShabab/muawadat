    ...
    function getDashboardData(dashboard_filter_url) {
        ...
        $.getJSON(dashboard_filter_url, { manager_id : manager_id ,date_filter: date_filter,reportType:reportType}, function (response) {
            if (response.status == 'Success') {
                ...
                $('#subscribed_users').html('+ ' + response.data.subscribed_users);
                ...
                $('#total_drafted_products').html(response.data.drafted_product_count);
                ...
                if (response.data.customers_increase != '') {
                    ...
                    $('#customers_change').append('<span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i>' + response.data.customers_increase + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else if (response.data.customers_decrease != '') {
                    $('#customers_change').html("");
                    $('#customers_change').append('<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i>' + response.data.customers_decrease + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else {
                    $('#customers_change').html("");
                    $('#customers_change').append('<span class="text-danger me-2">0%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                }
                if (response.data.orders_increase != '') {
                    $('#orders_change').html('');
                    $('#orders_change').append('<span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i>' + response.data.orders_increase + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else if (response.data.orders_decrease != '') {
                    $('#orders_change').html('');
                    $('#orders_change').append('<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i>' + response.data.orders_decrease + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else {
                    $('#orders_change').html('');
                    $('#orders_change').append('<span class="text-danger me-2">0%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                }
                if (response.data.revenue_increase != '') {
                    $('#revenue_change').html('');
                    $('#revenue_change').append('<span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i>' + response.data.revenue_increase + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else if (response.data.revenue_decrease != '') {
                    $('#revenue_change').html('');
                    $('#revenue_change').append('<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i>' + response.data.revenue_decrease + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else {
                    $('#revenue_change').html('');
                    $('#revenue_change').append('<span class="text-danger me-2">0%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                }
                if (response.data.products_increase != '') {
                    $('#products_change').html('');
                    $('#products_change').append('<span class="text-success me-2"><i class="mdi mdi-arrow-up-bold"></i>' + response.data.products_increase + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else if (response.data.products_decrease != '') {
                    $('#products_change').html('');
                    $('#products_change').append('<span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i>' + response.data.products_decrease + '%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                } else {
                    $('#products_change').html('');
                    $('#products_change').append('<span class="text-danger me-2">0%</span><span class="text-nowrap">' + sinceLastMonth +'</span>');
                }
