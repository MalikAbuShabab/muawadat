...
Route::group(['prefix' => 'v1', 'middleware' => ['ApiLocalization']], function () {
    ...
    Route::group(['middleware' => ['dbCheck', 'checkAuth']], function () { //apilogger
        ...
        // P2P MARKETPLACE API ROUTES
            Route::get('p2p/mybid-list', 'Api\v1\BuyerBidController@index');
            Route::get('p2p/marketplace-list', 'Api\v1\SellerBidController@index');
        ...
        // Route::get('/user-home-search', 'Api\v1\HomeController@userHomeSearch')->name('user.home.search');
