...
Route::group(['prefix' => 'v1', 'middleware' => ['ApiLocalization']], function () {
    ...
    Route::group(['middleware' => ['dbCheck', 'AppAuth']], function() {
       ...
       // Route::post('category-product-sync-dispatcher', 'Api\v1\DispatcherController@categoryProductSyncDispatcher')->middleware('ConnectDbFromDispatcher');
        ...
        // P2P BID API
        Route::get('mystore/brand/list', 'Api\v1\StoreController@getBrands');
        Route::get('mystore/brand/categories/{brand_id}', 'Api\v1\StoreController@brandCategories');
        Route::post('mystore/company-basic-info/store', 'Api\v1\StoreController@storeCompanyBasicInfo');
