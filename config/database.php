...
return [
    ...
    */
    ...
    'connections' => [
        ...
        //         PDO::MYSQL_ATTR_SSL_CA => null, // or set a CA path if required by RDS
        //     ]) : [],
        // ],

        // 'mydsql' => [
        //     'driver' => 'mysql',
        //     'url' => env('DATABASE_URL','p2p-marketplace-db-cluster.ct6gimiesp6k.me-central-1.rds.amazonaws.com'),
        ...
        'mysql' => [
            ...
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'royo_order'),
        ...
        'god' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_GOD'),
            'host' => env('DB_HOST_GOD', '127.0.0.1'),
            'port' => env('DB_PORT_GOD', '3306'),
            'database' => env('DB_DATABASE_GOD', 'forge'),
            'username' => env('DB_USERNAME_GOD', 'forge'),
            'password' => env('DB_PASSWORD_GOD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'PROD' => [
            ...
            'database' => env('DB_DATABASE_PROD', 'royoorders'),
        ...
        'mysql3' => [
            ...
            'database' => env('DB_DATABASE_SECOND', 'royo_salesdemo'),
            'username' => env('DB_USERNAME_SECOND', 'code'),
            'password' => env('DB_PASSWORD_SECOND', 'codebrew'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
