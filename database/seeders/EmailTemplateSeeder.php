    ...
    public function run(){
        $create_array = [
            ...
            [
                ...
                'tags' => '{customer_name}, {code}',
                'content' => '<tbody style="text-align: center;"><tr><td style="padding-top: 0;"><div style="background: #fff;box-shadow: 0 3px 4px #ddd;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;padding: 15px 40px 30px;"><b style="margin-bottom: 10px; display: block;">Hi {customer_name},</b><p>We received a request to change password for your account. Please use the following One-Time Password (OTP) to proceed:</p><div style="padding:10px;border: 2px dashed #cb202d;word-break:keep-all!important;width: calc(100% - 40px);margin: 25px auto;"><p style="Margin:0;Margin-bottom:16px;color:#cb202d;font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:20px;font-weight:600;line-height:1.5;margin:0;margin-bottom:0;padding:0;text-align:center;word-break:keep-all!important">{code}</p></div><p>Note: The OTP will expire in 10 minutes and can only be used once.</p></div></td></tr>
                </tbody>'
            ],
            [
                'label' => 'Withdraw Contract Otp',
                'subject' => 'Withdraw Contract Otp Email',
                'tags' => '{customer_name}, {code}',
                'content' => '<tbody style="text-align: center;"><tr><td style="padding-top: 0;"><div style="background: #fff;box-shadow: 0 3px 4px #ddd;border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;padding: 15px 40px 30px;"><b style="margin-bottom: 10px; display: block;">Hi {customer_name},</b><p>We received a request to Withdrawal Contract. Please use the following One-Time Password (OTP) to proceed:</p><div style="padding:10px;border: 2px dashed #cb202d;word-break:keep-all!important;width: calc(100% - 40px);margin: 25px auto;"><p style="Margin:0;Margin-bottom:16px;color:#cb202d;font-family:-apple-system,Helvetica,Arial,sans-serif;font-size:20px;font-weight:600;line-height:1.5;margin:0;margin-bottom:0;padding:0;text-align:center;word-break:keep-all!important">{code}</p></div><p>Note: The OTP will expire in 10 minutes and can only be used once.</p></div></td></tr>
                </tbody>'
            ],
        ];
