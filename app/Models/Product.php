...
class Product extends Model implements Auditable
{
  ...
  {
    return $this->hasOne('App\Models\FinancialInfo','company_id', 'id');
  }

 public function dynamicFormData()
{
    return $this->hasMany(ListingDynamicField::class, 'product_id', 'id');
}
  ...
  {
    return $this->hasMany('App\Models\ProductImage')->select('id', 'product_id', 'media_id', 'is_default', 'document_type','document_info');
  }
