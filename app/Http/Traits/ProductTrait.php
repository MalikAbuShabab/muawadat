...
trait ProductTrait{
    ...
    public function getProduct($product_id,$vendor_slug,$url_slug,$user='',$langId)
    {
       ...
       $with_array = [
            ...
            'category.categoryDetail.allParentsAccount','ServicePeriod', 'productVariantByRoles','financialInfo',
        ];
        ...
        // P2P Dynamic form field attributes
