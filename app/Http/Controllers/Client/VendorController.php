...
class VendorController extends BaseController
{
    ...
    public function updateConfig(Request $request, $domain = '',  $id)
    {
        ...
        $vendor->is_vendor_own_driver   = ($request->has('is_vendor_own_driver') && $request->is_vendor_own_driver == 'on') ? 1 : 0;
